  ...
  <body>
    ...
    <div class="container-fluid container-fluid-px py-6">
      ...
      <div class="row">
        ...
        <!-- Sidebar-->
        <div class="sidebar pr-xl-5 order-lg-1 col-lg-4 col-xl-3"><div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler">Product Categories<span class="block-toggler-icon"></span></a><div class="expand-lg collapse"><h5 class="sidebar-heading d-none d-lg-block">Category</h5><div class="sidebar-icon-menu mt-4 mt-lg-0"><div class="sidebar-icon-menu-item active" data-toggle="collapse" aria-expanded="true"><div class="d-flex align-items-center"><svg class="svg-icon sidebar-icon"><use xlink:href="#trousers-1"></use></svg><a class="sidebar-icon-menu-link font-weight-bold mr-2">Trousers</a><span class="sidebar-icon-menu-count"> 120</span></div><div class="collapse show"><ul class="sidebar-icon-menu sidebar-icon-submenu"><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Lorem ipsum</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Dolor</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Sit amet</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Donec vitae</a></li></ul></div></div><div class="sidebar-icon-menu-item active" data-toggle="collapse"><div class="d-flex align-items-center"><svg class="svg-icon sidebar-icon"><use xlink:href="#suit-1"></use></svg><a class="sidebar-icon-menu-link font-weight-bold mr-2">Jackets</a><span class="sidebar-icon-menu-count"> 55</span></div><div class="collapse"><ul class="sidebar-icon-menu sidebar-icon-submenu"><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Lorem ipsum</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Dolor</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Sit amet</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Donec vitae</a></li></ul></div></div><div class="sidebar-icon-menu-item active" data-toggle="collapse"><div class="d-flex align-items-center"><svg class="svg-icon sidebar-icon"><use xlink:href="#shirt5-1"></use></svg><a class="sidebar-icon-menu-link font-weight-bold mr-2">T-Shirts</a><span class="sidebar-icon-menu-count"> 33</span></div><div class="collapse"><ul class="sidebar-icon-menu sidebar-icon-submenu"><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Lorem ipsum</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Dolor</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Sit amet</a></li><li class="sidebar-icon-submenu-item"><a class="sidebar-icon-submenu-link link-animated link-animated-light" href="/category-full#">Donec vitae</a></li></ul></div></div></div></div></div><div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler" data-toggle="collapse">Filter by price<span class="block-toggler-icon"></span></a><div class="expand-lg collapse"><h5 class="sidebar-heading d-none d-lg-block">Price</h5><div class="mt-4 mt-lg-0 noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(16%, 0px) scale(0.28, 1);"></div></div><div class="noUi-origin" style="transform: translate(-840%, 0px); z-index: 5;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="110.0" aria-valuenow="40.0" aria-valuetext="40.00"><div class="noUi-touch-area"></div></div></div><div class="noUi-origin" style="transform: translate(-560%, 0px); z-index: 6;"><div class="noUi-handle noUi-handle-upper" data-handle="1" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="40.0" aria-valuemax="250.0" aria-valuenow="110.0" aria-valuetext="110.00"><div class="noUi-touch-area"></div></div></div></div></div><div class="nouislider-values  "><div class="min">From $<span id="slider-snap-value-from">40</span></div><div class="max">To $<span id="slider-snap-value-to">110</span></div></div></div></div><div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler" data-toggle="collapse">Filter by brand<span class="block-toggler-icon"></span></a><div class="expand-lg collapse"><h5 class="sidebar-heading d-none d-lg-block">Brand</h5><form class="mt-4 mt-lg-0"><div class="mb-1 form-group"><div class="custom-checkbox custom-control"><input type="checkbox" name="clothes-brand" id="brand0" class="custom-control-input" checked=""><label class="custom-control-label" for="brand0">Calvin Klein <small>(18)</small></label></div></div><div class="mb-1 form-group"><div class="custom-checkbox custom-control"><input type="checkbox" name="clothes-brand" id="brand1" class="custom-control-input" checked=""><label class="custom-control-label" for="brand1">Levi Strauss <small>(30)</small></label></div></div><div class="mb-1 form-group"><div class="custom-checkbox custom-control"><input type="checkbox" name="clothes-brand" id="brand2" class="custom-control-input"><label class="custom-control-label" for="brand2">Hugo Boss <small>(120)</small></label></div></div><div class="mb-1 form-group"><div class="custom-checkbox custom-control"><input type="checkbox" name="clothes-brand" id="brand3" class="custom-control-input"><label class="custom-control-label" for="brand3">Tomi Hilfiger <small>(70)</small></label></div></div><div class="mb-1 form-group"><div class="custom-checkbox custom-control"><input type="checkbox" name="clothes-brand" id="brand4" class="custom-control-input"><label class="custom-control-label" for="brand4">Tom Ford <small>(110)</small></label></div></div></form></div></div><div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler" data-toggle="collapse">Filter by size<span class="block-toggler-icon"></span></a><div class="expand-lg collapse"><h5 class="sidebar-heading d-none d-lg-block">Size</h5><form class="mt-4 mt-lg-0"><div class="mb-1 form-group"><div class="custom-radio custom-control"><input type="radio" name="size" id="size0" class="custom-control-input" checked=""><label class="custom-control-label" for="size0">Small</label></div></div><div class="mb-1 form-group"><div class="custom-radio custom-control"><input type="radio" name="size" id="size1" class="custom-control-input"><label class="custom-control-label" for="size1">Medium</label></div></div><div class="mb-1 form-group"><div class="custom-radio custom-control"><input type="radio" name="size" id="size2" class="custom-control-input"><label class="custom-control-label" for="size2">Large</label></div></div><div class="mb-1 form-group"><div class="custom-radio custom-control"><input type="radio" name="size" id="size3" class="custom-control-input"><label class="custom-control-label" for="size3">X-Large</label></div></div></form></div></div><div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler" data-toggle="collapse">Filter by colour<span class="block-toggler-icon"></span></a><div class="expand-lg collapse"><h5 class="sidebar-heading d-none d-lg-block">Colour</h5><ul class="list-inline mb-0 colours-wrapper mt-4 mt-lg-0"><li class="list-inline-item"><label for="value_sidebar_Blue" class="btn-colour " style="background-color: rgb(102, 140, 185);"></label><input name="colour" id="value_sidebar_Blue" type="checkbox" class="input-invisible form-check-input"></li><li class="list-inline-item"><label for="value_sidebar_White" class="btn-colour " style="background-color: rgb(255, 255, 255);"></label><input name="colour" id="value_sidebar_White" type="checkbox" class="input-invisible form-check-input"></li><li class="list-inline-item"><label for="value_sidebar_Violet" class="btn-colour " style="background-color: rgb(139, 110, 164);"></label><input name="colour" id="value_sidebar_Violet" type="checkbox" class="input-invisible form-check-input"></li><li class="list-inline-item"><label for="value_sidebar_Red" class="btn-colour " style="background-color: rgb(221, 98, 101);"></label><input name="colour" id="value_sidebar_Red" type="checkbox" class="input-invisible form-check-input"></li></ul></div></div></div>
      </div>
    </div>
    <!-- Footer-->
