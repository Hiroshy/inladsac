...
<html lang="<?= $app['lenguage']; ?>">
  ...
  <body>
    ...
    <div class="swiper-container home-slider" style="height: 80vh; min-height: 600px;">
      <!-- Additional required wrapper-->
      <div class="swiper-wrapper">
        <!-- Slides-->
        <div class="swiper-slide bg-cover bg-cover-left" style="background-image: url('../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/home-5.jpg');">
          <div class="container-fluid px-lg-6 h-100">
            <div class="row h-100 align-items-center" data-swiper-parallax="-500">
              <div class="col-lg-6 ml-auto">
                ...
                <h2 class="display-3" style="line-height: 1">Blouses &amp; Tops</h2>
        ...
        <div class="swiper-slide bg-cover bg-cover-right" style="background-image: url('../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/home-1.jpg');">
          <div class="container-fluid px-lg-6 h-100">
            <div class="row h-100 align-items-center" data-swiper-parallax="-500">
              <div class="col-lg-6">
                <p class="subtitle letter-spacing-3 mb-3 text-dark font-weight-light">Our all-time favourites</p>
        ...
        <div class="swiper-slide bg-cover" style="background-image: url('../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/home-2.jpg');">
          <div class="container-fluid px-lg-6 h-100">
            <div class="row h-100 justify-content-center align-items-center text-center" data-swiper-parallax="-500">
              <div class="col-lg-6">
                ...
                <h2 class="display-3" style="line-height: 1">Linen and denim</h2><a class="btn btn-dark" href="#">Start shopping</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container py-6">
      <div class="row">
        <div class="mb-2 col-6 col-lg-7pr-1">
          <div class="banner" style="background-color:#c6d5ea">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #425c81">Denim &amp; parkas</p>
              <h2 class="mb-0">Jackets      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-jackets-3-colour-bg-2.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Jackets</span></a>
          </div>
        </div>
        <div class="mb-2 col-6 col-lg-5pl-1">
          <div class="banner" style="background-color:#fce6e8">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #94585e">Get ready for winter</p>
              <h2 class="mb-0">Coats      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-coats-2-colour-bg-2.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Coats</span></a>
          </div>
        </div>
        <div class="mb-2 col-6 col-lg-5pr-1">
          <div class="banner" style="background-color:#faf7e6">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #9e9056">Let yourself shine</p>
              <h2 class="mb-0">Dresses      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-dresses-2-colour-bg-2.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Dresses</span></a>
          </div>
        </div>
        <div class="mb-2 col-6  col-lg-7pl-1">
          <div class="banner" style="background-color:#f8ebf5">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #9c5f8f">Latest denim trends</p>
              <h2 class="mb-0">Jeans      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-jeans-colour-bg-2.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Jeans</span></a>
          </div>
        </div>
        <div class="mb-2 col-6 col-lg-7pr-1">
          <div class="banner" style="background-color:#c9f2e4">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #418a70">Bags &amp; accessories</p>
              <h2 class="mb-0">Bags      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-bags-2-colour-bg-2.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Bags</span></a>
          </div>
        </div>
        <div class="mb-2 col-6 col-lg-5pl-1">
          <div class="banner" style="background-color:#ece2d6">
            <div class="banner-text p-3 p-lg-5">
              <p class="subtitle text-sm" style="color: #775a3d">Shoes &amp; footwear</p>
              <h2 class="mb-0">Shoes      </h2>
            </div>
            <div class="banner-bg"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/category-shoes-colour-bg.jpg" alt=""></div><a class="stretched-link banner-link" href="#"><span class="sr-only">See Shoes</span></a>
          </div>
        </div>
      </div>
    </div>
    <div class="container py-6">
      ...
      <div class="row justify-content-between align-items-center mb-4">
        <div class="col-12 col-md">
          <ul class="list-inline text-center text-md-left mb-3 mb-md-0"> 
        ...
        <div class="col-12 col-md-auto text-center"><a class="btn btn-link px-0" href="#">All products</a></div>
      </div>
      <div class="row">
        <!-- product-->
    ...
    <div class="container py-6 text-center">
      <h4 class="h1 mb-3">Summer Sales</h4>
      <h5 class="h2 font-weight-light mb-5">Our biggest sales this year &mdash; up to 60% off!</h5>
      <p class="h5 text-muted mb-5">The bedding was hardly able to cover it and seemed ready to slide off any moment!</p><a class="btn btn-dark" href="#">Start shopping</a>
    </div>
    <!-- Sidebar Cart Modal-->
