  ...
  <body>
        ...
        <div class="swiper-slide">
          <div class="container h-100">
            <div class="row h-100 align-items-center">
              ...
              <div class="col-sm-6 text-center"><img class="img-fluid home-slider-image" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock-transparent.png" alt="" style="max-height: 500px" data-swiper-parallax="-200">
        ...
        <div class="swiper-slide bg-cover-left">
          <div class="container h-100">
            <div class="row h-100 align-items-center">
              ...
              <div class="col-sm-6 text-center"><img class="img-fluid home-slider-image" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair2-transparent.png" alt="" style="max-height: 500px" data-swiper-parallax="-200">
        ...
        <div class="swiper-slide bg-cover-right">
          <div class="container h-100">
            <div class="row h-100 align-items-center">
              ...
              <div class="col-sm-6 text-center"><img class="img-fluid home-slider-image" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box-transparent.png" alt="" style="max-height: 500px" data-swiper-parallax="-200">
    ...
    <section class="py-6">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4 mb-lg-6 pt-md-3 hover-scale"><a href="detail-2"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/book-sq.jpg" alt=""></a>
            <div class="px-4 position-relative z- mt--3"><a class="text-dark text-decoration-none" href="detail-2">
                <h3>Furniture<br>source<br>book   </h3>
                <p class="text-muted">$39.90</p></a>
              <p> <a class="btn btn-link text-dark text-decoration-none px-0" href="detail-2"> Shop now                       </a></p>
            </div>
          </div>
          <div class="col-md-7 ml-auto mb-4 mb-lg-5 hover-scale">
            <div class="position-absolute z-index-5 py-6"><a class="text-dark text-decoration-none" href="detail-1">
                <h2>Norwegg<br>design<br>chair    </h2>
                <p class="text-muted">$139.90</p></a>
              <p> <a class="btn btn-link text-dark text-decoration-none px-0" href="detail-1"> Shop now      </a></p>
            </div>
            <div class="ml-6"><a href="detail-1"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair-2-sq.jpg" alt=""></a></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 ml-auto pt-lg-6 mb-4 mb-lg-5 order-md-2 hover-scale"><a class="text-dark text-decoration-none" href="detail-1"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box-sq.jpg" alt=""></a>
            <div class="px-4 position-relative z- mt--3"><a class="text-dark text-decoration-none" href="detail-1">
          ...
          <div class="col-md-7 mb-4 mb-lg-5 order-md-1 hover-scale">
            <div class="position-absolute z-index-5 py-6"><a class="text-dark text-decoration-none" href="detail-2">
                <h2>Sunn<br>Clock<br></h2>
                <p class="text-muted">$89.90</p></a>
              <p> <a class="btn btn-link text-dark text-decoration-none px-0" href="detail-2"> Shop now                        </a></p>
            </div>
            <div class="ml-6"><a href="detail-2"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock-sq.jpg" alt=""></a></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 pt-md-3 mb-4 mb-lg-5 hover-scale"><a href="detail-2"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock2-sq.jpg" alt=""></a>
            <div class="px-4 position-relative z- mt--3"><a class="text-dark text-decoration-none" href="detail-2">
          ...
          <div class="col-md-8 ml-auto hover-scale">
            ...
            <div class="ml-6"><a href="detail-1"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair3-3-sq.jpg" alt=""></a></div>
          </div>
        </div>
      </div>
    </section>
    <div class="position-relative py-5" style="background-color: #ebf7ff;">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 text-center"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair2-transparent.png" alt="" style="max-height: 450px;"></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-secondary">Fresh</div><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair-2.jpg" alt="product"/></div></a>
          ...
          <div class="col-xl-3 col-md-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/book.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/book-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
            ...
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-primary">Sale</div><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair2.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair2-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="col-xl-3 col-md-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair3.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair3-3.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="col-xl-3 col-md-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="col-xl-3 col-md-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock3.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/clock3-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
            ...
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-dark">Sold out</div><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="col-xl-3 col-md-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1">
                  <div class="product-swap-image"><img class="img-fluid product-swap-image-front" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box2.jpg" alt="product"/><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/box-2.jpg" alt="product"/></div></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
