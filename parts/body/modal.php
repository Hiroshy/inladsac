            ...
            <div class="modal-body px-5 pb-5">
                <div>
                    ...
                    <ul class="nav flex-column mb-5">
                        <li class="nav-item active"><a class="nav-link pl-0" href="<?= $app["address"]["peru"][1] ?>"><?= $app["address"]["peru"][0] ?></a></li>
                        <li class="nav-item"><a class="nav-link pl-0" href="mailto:<?= $mi_email ?>"><?= $mi_email?></a></li>
                        <li class="nav-item"><a class="nav-link pl-0 disabled" href="#">Disabled</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link pl-0 dropdown-toggle" id="navbarDropdownMenuLink" href="#" data-target="#sidebarSubmenu" data-toggle="collapse" aria-haspopup="true" aria-expanded="false">Dropdown link</a>
