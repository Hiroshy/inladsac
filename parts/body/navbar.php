    ...
    <div class="top-bar text-sm bg-transparent">
        <div class="container-fluid px-lg-5 py-3">
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 col-md-4 text-center text-md-center">
                    <p class="mb-0"><?= $app['notice']; ?></p>
                </div>
                <div class="col-sm-6 col-md-4 d-none d-sm-flex justify-content-end">
                    <!-- Language Dropdown-->
                    <div class="dropdown border-right px-3">
                        <a class="dropdown-toggle topbar-link" id="langsDropdown" href="#" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">Spanish</a>
                    ...
                    <div class="dropdown pl-3 ml-0">
                        <a class="dropdown-toggle topbar-link" id="currencyDropdown" href="#" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">USD</a>
...
<!-- Top Bar End-->
<nav id="main_menu" class="navbar navbar-expand-lg bg-light border-0 shadow-0 navbar-light px-lg-5 sticky-top">
