<div class="swiper-container home-slider" style="height: 95vh; min-height: 600px;">
      ...
      <div class="swiper-wrapper">
        <!-- Slides-->
        <div class="swiper-slide bg-cover bg-cover-right" style="background-image: url('/img/photo/radwag_balanzas.jpg');">
        ...
        <div class="swiper-slide bg-cover" style="background-image: url('/img/photo/memert_productos.jpg');">
          <div class="container-fluid px-lg-6 px-xl-7 h-100">
        ...
        <div class="swiper-slide bg-cover" style="background-image: url('/img/photo/ilblow_alcoholimetros.jpg');">
          <div class="container-fluid px-lg-6 px-xl-7 h-100">
            <div class="row h-100 align-items-center" data-swiper-parallax="-500">
