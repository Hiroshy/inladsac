...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/post.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:14 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Swiper-->
    <link rel="stylesheet" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/swiper/css/swiper.min.css">
    <!-- AOS - AnimationOnScroll-->
    <link rel="stylesheet" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/aos/aos.css">
    <!-- Custom Scrollbar-->
    <link rel="stylesheet" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css">
    <!-- Theme stylesheet-->
    <link rel="stylesheet" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/css/style.default.d1b89a2d.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/css/custom.0a822280.css">
    <!-- Favicon-->
    <link rel="shortcut icon" href="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/favicon.png">
    <!-- FontAwesome-->
  ...
  <body>
    ...
    <header class="header"> 
      ...
      <!-- Top Bar End-->
      <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-5"><a class="navbar-brand" href="index-2.html">Varkala</a>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav mt-3 mt-lg-0">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="homeDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
              <div class="dropdown-menu" aria-labelledby="homeDropdown"><a class="dropdown-item" href="index-2.html">Home 1 - Fashion </a><a class="dropdown-item" href="index-3.html">Home 2 - Fashion </a><a class="dropdown-item" href="index-4.html">Home 3 - Design <span class="badge badge-primary-light ml-1">New</span> </a><a class="dropdown-item" href="index-5.html">Home 4 - Design <span class="badge badge-primary-light ml-1">New</span> </a>
              </div>
            </li>
                ...
                <div class="row">
                  <div class="col-lg-3 col-sm-6"><img class="img-fluid mb-3 d-none d-lg-block" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/christopher-campbell-28571-unsplash.jpg" alt=""/>
                    ...
                    <ul class="megamenu-list list-unstyled">
                      <li class="megamenu-list-item"><a class="megamenu-list-link" href="index-2.html">Home 1 - Fashion   </a></li>
                      <li class="megamenu-list-item"><a class="megamenu-list-link" href="index-3.html">Home 2 - Fashion   </a></li>
                      <li class="megamenu-list-item"><a class="megamenu-list-link" href="index-4.html">Home 3 - Design <span class="badge badge-primary-light ml-1">New</span>   </a></li>
                      <li class="megamenu-list-item"><a class="megamenu-list-link" href="index-5.html">Home 4 - Design <span class="badge badge-primary-light ml-1">New</span>   </a></li>
                    </ul>
                    <!-- Megamenu list-->
                    <h6>Category</h6>
        ...
        <div class="row"> 
          <div class="col-xl-8 col-lg-10 mx-auto">
            ...
            <div class="hero-content">
              ...
              <div><p class="text-muted mb-0"><a href="#"><img src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/person-3.jpg" alt="" class="w-2rem rounded-circle mr-2"></a> By <a href="#" class="text-muted font-weight-bold">John Slim</a> <span class="mx-1">|</span> January 16, 2016 in <a href="blog.html" class="font-weight-bold">Fashion</a> <span class="mx-1">|</span> <a href="#comments" class="text-muted" data-smooth-scroll>2 comments</a></p></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-xl-11 mx-auto"><img class="img-fluid mb-5" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/ian-dooley-347942-unsplash.jpg" alt=""></div>
        </div>
        <div class="row">
          <div class="col-xl-8 col-lg-10 mx-auto">           
            <p class="lead mb-5">
            ...
            <div class="text-content text-lg">
              <p>
                <span class="capital text-dark">P</span>ellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. <em>Aenean ultricies mi vitae est.</em> Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, <code>commodo vitae</code>, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. <a href="#">Donec non enim</a> in turpis pulvinar facilisis. Ut felis.</p>
              <p class="text-center text-muted text-sm"><img class="img-fluid mb-2" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/ian-dooley-347962-unsplash.jpg" alt="Example blog post alt"><br>Photo by Jack Tran, New York</p>
              ...
              <h4>A nice list here</h4>
              <ul class="list-icon">
                <li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.  </li>
                <li>Aliquam tincidunt mauris eu risus.</li>
                <li>Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus</li>
                <li>Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci.</li>
              </ul>
              <p><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/christopher-campbell-28571-unsplash.jpg" alt="Example blog post alt"></p>
              <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, commodo vitae, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. Donec non enim in turpis pulvinar facilisis. Ut felis. Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus                   </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/christopher-campbell-28571-unsplash.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Pellentesque habitant morbi          </a></h5>
          ...
          <!-- post-->
          <div class="col-lg-4 col-sm-6 mb-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/ian-dooley-347942-unsplash.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Best books about Fashion          </a></h5>
              <p class="text-gray-500 text-sm"><a class="text-uppercase text-xs mr-2" href="#">Fashion and style</a>January 16, 2019</p>
            </div>
          </div>
          <!-- /post end-->
          <!-- post-->
          <div class="col-lg-4 col-sm-6 mb-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/ian-dooley-347962-unsplash.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Best books about Fashion          </a></h5>
              <p class="text-gray-500 text-sm"><a class="text-uppercase text-xs mr-2" href="#">Fashion and style</a>January 16, 2019</p>
            </div>
          </div>
    ...
    <section class="py-5" id="comments">
      <div class="container">
        <div class="row">
          <div class="col-xl-8 col-lg-10 mx-auto">   
            <h6 class="h4 text-primary text-uppercase text-lg-right mb-6">2 comments</h6>
            <!-- comment-->
            <div class="row mb-4">
              <div class="col-3 col-md-2 text-center-xs">
                <p><img class="img-fluid rounded-circle" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/person-3.jpg" alt=""></p>
              </div>
            ...
            <div class="row mb-4">
              <div class="col-3 col-md-2 text-center-xs">
                <p><img class="img-fluid rounded-circle" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-0.jpg" alt=""></p>
              </div>
              <div class="col-9 col-md-10">
                <h5>Louise Armero</h5>
            ...
            <form class="my-5 form" id="comment-form" method="get" action="#">
              <div class="row">
                <div class="col-md-6">                           
                  <div class="form-group mb-4">
                    <label class="form-label" for="nameComment">Name <span class="required">*</span></label>
                    <input class="form-control form-control-underlined" id="nameComment" type="text">
                  </div>
                </div>
                <div class="col-md-6">                                              
                  <div class="form-group mb-4">
                    <label class="form-label" for="Comment">Email <span class="required">*</span></label>
                    <input class="form-control form-control-underlined" id="Comment" type="text">
                  </div>
                </div>
              </div>
              <div class="form-group mb-4">
                <label class="form-label" for="commentComment">Comment <span class="required">*</span></label>
                <textarea class="form-control form-control-underlined" id="commentComment" rows="4"></textarea>
              </div>
              <button class="btn btn-outline-primary" type="submit"> Leave comment                                   </button>
            </form>
            <!-- /comment form-->
          </div>
        </div>
