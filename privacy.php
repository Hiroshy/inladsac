...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/privacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:17 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          <h1 class="hero-heading mb-3">Privacy Policy</h1>
          <div><p class="text-muted mb-0">Effective date: November 22, 2019</p></div>
        </div>
      </div>
    </section>
    <!-- customer login-->
    <section class="pb-6">
      <div class="container">
        <div class="row">
          <div class="col-xl-9 text-content">
